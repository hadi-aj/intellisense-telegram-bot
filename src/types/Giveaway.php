 ...
 * @property Integer $winners_selection_date Point in time (Unix timestamp) when winners of the giveaway will be selected
 * @property Integer $winner_count The number of users which are supposed to be selected as winners of the giveaway
 * @property True $only_new_members Optional. True, if only users who join the chats after the giveaway started should be eligible to win
 * @property True $has_public_winners Optional. True, if the list of giveaway winners will be visible to everyone
